...
function QuestsContent() {
  ...
  if (queryError)
    return (
      <div className='p-4 text-destructive' data-testid='error-message'>
                                  ...
                                  <div key={phase.id}>
                                    ...
                                    <div className='flex flex-wrap gap-1 mt-1'>
                                      {phase.rewards?.map(reward => (
                                        <span
                                          key={reward.id}
                                          className='inline-flex items-center px-2 py-0.5 rounded text-xs bg-amber-500/10 text-amber-500'
                                        >
                                          {reward.rewardType}
                                          {reward.amount &&
                                            `: ${reward.amount}`}
