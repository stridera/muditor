...
export type ExitState = 'CLOSED' | 'LOCKED' | 'OPEN';
...
export type GetObjectInlineQuery = {
  ...
  object: {
    ...
    wearFlags: Array<WearFlag>;
    restrictions: Array<ObjectRestriction>;
    restrictedClassIds: Array<number>;
    restrictedAlignments: Array<Alignment>;
    restrictedRaces: Array<Race>;
    allowedRaces: Array<Race>;
    minSize?: Size | null;
...
export type DeleteTriggerFromScriptsPageMutation = {
  __typename?: 'Mutation';
  deleteTrigger: { __typename?: 'TriggerDto'; id: number; zoneId: number };
};
...
export type GetCharacterDetailsInlineQuery = {
  ...
  character: {
    ...
    damageRoll: number;
    armorClass: number;
    playerFlags?: Array<string> | null;
    privilegeFlags?: Array<string> | null;
    invisLevel: number;
    birthTime: any;
...
export type UpdateMobMutation = {
  ...
  updateMob: {
    ...
    behaviors: Array<MobBehavior>;
    professions: Array<MobProfession>;
    aggressionFormula?: string | null;
    activityRestrictions?: string | null;
    riderPresenceMessage?: string | null;
    position: Position;
    defaultPosition: Position;
    movementMode: MovementMode;
    defaultMovementMode: MovementMode;
...
export type DetachTriggerMutation = {
  __typename?: 'Mutation';
  detachTrigger: { __typename?: 'TriggerDto'; id: number; zoneId: number };
};
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          ...
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'restrictedClassIds' },
          },
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'restrictedAlignments' },
          },
          { kind: 'Field', name: { kind: 'Name', value: 'restrictedRaces' } },
          { kind: 'Field', name: { kind: 'Name', value: 'allowedRaces' } },
          { kind: 'Field', name: { kind: 'Name', value: 'minSize' } },
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          ...
          { kind: 'Field', name: { kind: 'Name', value: 'mobZoneId' } },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'restrictedRaces' },
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'allowedRaces' },
                },
                { kind: 'Field', name: { kind: 'Name', value: 'minSize' } },
                { kind: 'Field', name: { kind: 'Name', value: 'maxSize' } },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'passengerCapacity' },
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'presenceOverride' },
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'grantedEffects' },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'behaviors' } },
                { kind: 'Field', name: { kind: 'Name', value: 'professions' } },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'aggressionFormula' },
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'activityRestrictions' },
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'riderPresenceMessage' },
                },
                { kind: 'Field', name: { kind: 'Name', value: 'position' } },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'defaultPosition' },
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'movementMode' },
                },
                {
                  kind: 'Field',
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'baseLightLevel' },
                },
                { kind: 'Field', name: { kind: 'Name', value: 'capacity' } },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'magicAffinity' },
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'requiredMechanic' },
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'entryRestriction' },
                },
                { kind: 'Field', name: { kind: 'Name', value: 'isPeaceful' } },
                { kind: 'Field', name: { kind: 'Name', value: 'allowsMagic' } },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'allowsRecall' },
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'allowsSummon' },
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'allowsTeleport' },
                },
                { kind: 'Field', name: { kind: 'Name', value: 'isDeathTrap' } },
                {
                  kind: 'Field',
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'toZoneId' },
                      },
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'toRoomId' },
                      },
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'roomZoneId' },
                      },
                      {
                        kind: 'Field',
...
>;
export const BanPlayerDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'BanPlayer' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
...
} as unknown as DocumentNode<BanPlayerMutation, BanPlayerMutationVariables>;
