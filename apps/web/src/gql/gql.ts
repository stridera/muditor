...
const documents: Documents = {
    ...
    "\n  mutation DeleteMobCarrying($id: ID!) {\n    deleteMobCarrying(id: $id)\n  }\n": types.DeleteMobCarryingDocument,
    "\n  mutation DeleteMobEquipped($id: ID!) {\n    deleteMobEquipped(id: $id)\n  }\n": types.DeleteMobEquippedDocument,
